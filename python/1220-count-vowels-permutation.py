        ...
        if n == 1:
            ...
            if c == "e":
                self.Memo[("e", n)] = self.countVowelPermutation(
                    n - 1, "a"
                ) + self.countVowelPermutation(n - 1, "i")
                return self.Memo[("e", n)]
            if c == "i":
                self.Memo[("i", n)] = (
                    self.countVowelPermutation(n - 1, "a")
                    + self.countVowelPermutation(n - 1, "e")
                    + self.countVowelPermutation(n - 1, "o")
                    + self.countVowelPermutation(n - 1, "u")
                )
